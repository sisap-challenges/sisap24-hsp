...
if bindings_dir in os.path.basename(os.getcwd()):
    ...
    include_dirs.extend(['../GraphHierarchy/'])
else:
...
setup(
    name='GraphHierarchy',
    version=__version__,
    description='GraphHierarchy',
    author='Cole Foster, adapted from the work of Yury Malkov',
    url='https://github.com/cole-foster/sisap-2024.git',
    long_description="""GraphHierarchy""",
